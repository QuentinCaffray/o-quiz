...
export const authedRequester = buildAuthedRequester(generateFakeUser({ role: "member" })); // Request en tant que member
export const authorRequester = buildAuthedRequester(generateFakeUser({ role: "author"})); // Request en tant qu'auteur
export const adminRequester = buildAuthedRequester(generateFakeUser({ role: "admin"}));
